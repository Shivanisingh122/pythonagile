...
df_users = pd.read_excel('C:/Users/SHIVANI SINGH/Downloads/Book1.xlsx', sheet_name='Sheet3')
df_activity = pd.read_excel('C:/Users/SHIVANI SINGH/Downloads/Book1.xlsx', sheet_name='Sheet4')
...
with pd.ExcelWriter('C:/Users/SHIVANI SINGH/Downloads/Book1.xlsx', engine='openpyxl', mode='a') as writer:
    df_leaderboard.to_excel(writer, sheet_name='SHEET5', index=False)
...
with pd.ExcelWriter('C:/Users/SHIVANI SINGH/Downloads/Book1.xlsx', engine='openpyxl', mode='a') as writer:
    leaderboard.to_excel(writer, sheet_name='Sheet6',index=False)
